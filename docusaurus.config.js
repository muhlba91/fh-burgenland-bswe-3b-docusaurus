...
const config = {
  ...
  baseUrl: '/fh-burgenland-bswe-3b-docusaurus/',

  // GitHub pages deployment config.
  // If you aren't using GitHub pages, you don't need these.
  organizationName: 'muhlba91', // Usually your GitHub org/user name.
  projectName: 'fh-burgenland-bswe-3b-docusaurus', // Usually your repo name.
    ...
    ({
      ...
      navbar: {
        ...
        items: [
          ...
          {
            href: 'https://github.com/muhlba91/fh-burgenland-bswe-3b-docusaurus.git',
            label: 'GitHub',
            position: 'right',
          },
        ],
